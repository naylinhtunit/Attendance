			...
			<div class="modal-body m-3">
				<form method="post" action="{{ url('/holiday') }}">
					...
					<div class="form-group">
						...
						<input type="text" name="holiday_name" class="form-control" id="holiday_name" placeholder="Holiday Name">
					</div>
					<div class="form-group">
						<label for="date">Holiday Date</label>
						<input type="date" name="holiday_date" id="date" class="form-control" />
					</div>
					<div class="form-group">
