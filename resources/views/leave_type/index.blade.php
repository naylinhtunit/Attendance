			...
			<div class="modal-body m-3">
				<form method="post" action="{{ url('/leave_type') }}">
					...
					<div class="form-group">
						...
						<input type="text" name="leave_name" class="form-control" id="leave_name" placeholder="Leave Name">
					</div>
					<div class="form-group">
						<label for="total_leave">Total Leave</label>
						<input type="number" name="total_leave" id="total_leave" class="form-control" placeholder="12" />
					</div>
